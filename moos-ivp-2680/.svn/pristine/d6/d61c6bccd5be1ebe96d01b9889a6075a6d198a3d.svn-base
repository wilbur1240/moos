...
/*    DATE: Aug 31st 2024  (to diambiguate from SimpleWaypoint)  */
/*                                                               */
...
BHV_SimpleWaypoint2::BHV_SimpleWaypoint2(IvPDomain gdomain) : 
  IvPBehavior(gdomain)
{
...
bool BHV_SimpleWaypoint2::setParam(string param, string val) 
{
...
void BHV_SimpleWaypoint2::onIdleState() 
{
  postViewPoint(false);
}
...
void BHV_SimpleWaypoint2::postViewPoint(bool viewable) 
{
...
IvPFunction *BHV_SimpleWaypoint2::onRunState() 
{
...
IvPFunction *BHV_SimpleWaypoint2::buildFunctionWithZAIC() 
{
...
IvPFunction *BHV_SimpleWaypoint2::buildFunctionWithReflector() 
{

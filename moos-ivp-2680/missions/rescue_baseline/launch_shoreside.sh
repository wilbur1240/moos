...
for ARGI; do
	...
	echo "  -10 : Short for --swim_file=mit_90x_10.txt     "
	echo "  -11 : Short for --swim_file=mit_90x_11.txt     "
	echo "  -12 : Short for --swim_file=mit_90x_12.txt     "
	echo "  -13 : Short for --swim_file=mit_90x_13.txt     "
	echo "  -14 : Short for --swim_file=mit_90x_14.txt     "
	exit 0;
	...
	MOOS_PORT="${ARGI#--mport=*}"
        ...
        SWIM_FILE="mit_90x_10.txt"
    elif [ "${ARGI}" = "-11" ]; then
        SWIM_FILE="mit_90x_11.txt"
    elif [ "${ARGI}" = "-12" ]; then
        SWIM_FILE="mit_90x_12.txt"
    elif [ "${ARGI}" = "-13" ]; then
        SWIM_FILE="mit_90x_13.txt"
    elif [ "${ARGI}" = "-14" ]; then
        SWIM_FILE="mit_90x_14.txt"

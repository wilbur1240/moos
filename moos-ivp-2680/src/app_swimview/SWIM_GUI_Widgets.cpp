...
void SWIM_GUI::initWidgets()
{
  ...
  // Main Ship Viewer
  //=================================================
  m_swim_viewer = new SwimViewer(5, 30, w()-10, h()-60);
  m_mviewer     = m_swim_viewer;
...
void SWIM_GUI::resizeWidgetsShape()
{
  ...
  // Main Ship Viewer
  //===================================================
  m_swim_viewer->resize(5, 30, w()-10, h()-60);
...
void SWIM_GUI::resizeWidgetsText()
{
  int text_size  = 12;
  int label_size = 12;

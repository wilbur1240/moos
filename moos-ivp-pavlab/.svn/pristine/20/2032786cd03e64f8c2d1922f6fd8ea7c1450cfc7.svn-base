...
BHV_LegRunG::BHV_LegRunG(IvPDomain gdomain) : IvPBehavior(gdomain)
{
  // =================================================
  // Superclass vars
...
bool BHV_LegRunG::setParam(string param, string value) 
{
  if(param == "speed")
...
bool BHV_LegRunG::setEngineParam(string param, string value)
      {
...
bool BHV_LegRunG::setInitLegMode(string str)
{
...
void BHV_LegRunG::onSetParamComplete()
{
...
void BHV_LegRunG::onRunToIdleState() 
{
  eraseAllViewables();
...
void BHV_LegRunG::onIdleToRunState() 
{
  m_preview_pending = true;
  m_mode = "init";
  initLegMode();
...
IvPFunction *BHV_LegRunG::onRunState() 
{
...
bool BHV_LegRunG::onRunStateTurnMode() 
{
...
bool BHV_LegRunG::onRunStateLegMode() 
{
  // Sanity check
...
void BHV_LegRunG::setMode(string mode)
{
...
void BHV_LegRunG::handleModeSwitch()
{
  // Sanity checks
...
IvPFunction *BHV_LegRunG::buildOF() 
{
...
bool BHV_LegRunG::initTurnPoints()
{
  if((m_mode != "turn1") && (m_mode != "turn2"))
    return(false);
...
void BHV_LegRunG::postAllSegList(bool active)
{
  return;
...
void BHV_LegRunG::postLegSegList(bool active)
{
  return;
...
void BHV_LegRunG::postLegRing(bool active)
{
  return;
  XYPolygon ringpoly;
...
void BHV_LegRunG::postTurnSegList(bool active)
{
...
void BHV_LegRunG::postTurnPreview(bool active)
{
...
void BHV_LegRunG::postSteerPoints(bool active)
{
...
void BHV_LegRunG::postLegPoints(bool active)
{
  XYPoint p1 = m_legrun.getPoint1();
  XYPoint p2 = m_legrun.getPoint2();
...
void BHV_LegRunG::eraseAllViewables()
{
  postLegSegList(false);
  postTurnSegList(false);
  postSteerPoints(false); 
...
bool BHV_LegRunG::handleConfigLegSpeed(string str)
{
...
void BHV_LegRunG::advanceModePending()
{
  if(m_mode == "leg1")
...
void BHV_LegRunG::postConfigStatus()
{
  string str = "type=BHV_LegRunG,name=" + m_descriptor;
...
string BHV_LegRunG::expandMacros(string sdata)
{
  // =======================================================
...
void BHV_LegRunG::postTurnPoints(bool active)
{

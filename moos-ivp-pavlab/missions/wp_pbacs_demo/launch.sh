...
for ARGI; do
	...
	echo "                                                           "
	echo "  Examples:                                                "
	echo "  ./launch.sh     // 4 vehicles, small grid                "
	echo "  ./launch.sh --vnum=3 -FG  // 3 vehicles, large grid      "
...
if [ $GRIDSIZE = "-SG" ]; then
    ...
    #  For the WestPoint demo, the grid is rotated and actually looks like this,
    #  But the math below is easier to understand if you look at the grid boundary points
    #  shown above.  The math generalizes well. 
#   (4) ----------- (3)
#    |               |
#    |               |
#    |               |

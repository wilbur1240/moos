...
for ARGI; do
	...
	echo "  --vname1          Set the name for the first   " 
	echo "                    vehicle to display in special" 
	echo "                    pMarineVeiwer window         " 
	echo "  --vnameN          See above, same for Nth vehic" 
        echo "                                                 "
	...
	MOOS_PORT="${ARGI#--mport=*}"
        ...
        VNAME2="${ARGI#--vname2=*}"
    elif [ "${ARGI:0:9}" = "--vname3=" ]; then
        VNAME3="${ARGI#--vname3=*}"
    elif [ "${ARGI:0:9}" = "--vname4=" ]; then
        VNAME4="${ARGI#--vname4=*}"

...
void showHelpAndExit()
{
  ...
  blk("      Launch pGenGreedyRescue with the given process name         ");
  blk("      rather than pGenGreedyRescue.                           ");
  mag("  --example, -e                                                 ");
...
void showExampleConfigAndExit()
{
  ...
  blu("=============================================================== ");
  blk("                                                                ");
  blk("ProcessConfig = pGenGreedyRescue                          ");
  blk("{                                                               ");
  blk("  AppTick   = 4                                                 ");
  blk("  CommsTick = 4                                                 ");
  blk("                                                                ");
...
void showInterfaceAndExit()
{
  ...
  blk("SUBSCRIPTIONS:                                                  ");
  blk("------------------------------------                            ");
  blk("  NODE_MESSAGE = src_node=HENRY,dest_node=GILDA,var_name=FOO,   ");
  blk("                 string_val=BAR                                 ");
  blk("                                                                ");
  blk("PUBLICATIONS:                                                   ");
  blk("------------------------------------                            ");

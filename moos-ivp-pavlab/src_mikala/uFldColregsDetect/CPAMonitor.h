...
class CPAMonitor
{
 ...
 protected: // Local utility functions
  ...
  bool        updatePairSituation(std::string, std::string); //Mikala added

  double      relBng(std::string vname1, std::string vname2);
  double      targAng(std::string vname1, std::string vname2); //Mikala added
 ...
 protected: // map keyed on coupled vname#contact, abe#bob
  ...
  std::map<std::string, bool>       m_map_pair_situation_examined; //mikala added
  std::map<std::string, std::string>       m_map_pair_situation; //mikala added
